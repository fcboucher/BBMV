...
source('PATH_TO_THIS_SCRIPT/Simulate BBM+V.R', chdir = TRUE) # change the path to this script
source('PATH_TO_THIS_SCRIPT/BBM+V_functions_MLoptim.R', chdir = TRUE) # change the path to this script
source('PATH_TO_THIS_SCRIPT/plot.landscape.BBMV.R', chdir = TRUE) # change the path to this script
