...
get.landscape.BBMV=function(model,Npts=50,main='Macroevolutionary landscape',ylab='-V',xlab='Trait',xlim=NULL,ylim=NULL){
...
get.multiple.landscapes.BBMV=function(models,Npts=50,xlim=NULL,ylim=NULL,main='Macroevolutionary landscapes',ylab='-V',xlab='Trait'){
	trm=c()
