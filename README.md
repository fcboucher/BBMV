...
The [example script](https://github.com/fcboucher/BBMV/blob/master/Example_ML_MCMC.R) shows basic examples of use of the functions to simulate and infer under BBM+V. 
